const CATEGORIES = [
  { id: 1, label: "Necklaces & Pendants", image: "https://res.cloudinary.com/dnnk7dymx/image/upload/v1782222756/Search_ljovkh.jpg" },
  { id: 2, label: "Bracelets", image: "https://res.cloudinary.com/dnnk7dymx/image/upload/v1782222755/Rhinestone_Decor_Bracelet_v616al.jpg" },
  { id: 3, label: "Earrings", image: "https://res.cloudinary.com/dnnk7dymx/image/upload/v1782222756/Adding_sparkle_to_your_everyday_look_with_the_elegance_of_a_round-cut_diamond_emxcka.webp" },
  { id: 4, label: "Rings", image: "https://res.cloudinary.com/dnnk7dymx/image/upload/v1782222753/Lily___Full_Cut_Round_marquise_Diamond_Band_mxpac2.jpg" },
  { id: 5, label: "Watches", image: "https://res.cloudinary.com/dnnk7dymx/image/upload/v1782222756/25_Elegant_Timepieces_for_Women_ldzxmy.jpg" },
];

export default function Categories() {
  return (
    <section className="relative z-20 w-full bg-[#0a0a0a] py-16 sm:py-20 md:py-24 px-5 sm:px-8 md:px-12">
