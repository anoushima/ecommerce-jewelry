  ...
  return (
    <nav className="flex items-center justify-between px-12 py-[18px] border-b border-white/10 bg-[#0a0a0a]">
      ...
      <div className="flex items-center gap-5 flex-1">
        <button
          aria-label="Search"
          className="text-[#b0aaa3] hover:text-white transition-colors cursor-pointer"
        >
      ...
      <div className="flex items-center gap-8">
        {NAV_LINKS.map((link) => (
          <a
            key={link}
            href="#"
            className="font-montserrat text-[10px] font-normal tracking-[0.18em] uppercase text-[#b0aaa3] hover:text-white transition-colors pb-[3px] relative after:absolute after:bottom-0 after:left-0 after:h-px after:w-0 after:bg-white hover:after:w-full after:transition-all after:duration-300"
          >
            {link}
          </a>
        ))}
