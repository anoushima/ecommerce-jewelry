export default function Hero() {
  return (
    <section className="relative min-h-[85vh] sm:min-h-[85vh] overflow-hidden bg-[#0b0a09]">
      {/* Background Image 1 */}
      <div
      ...
      <div className="relative z-10 flex min-h-[85vh] items-center px-6 sm:px-12 md:px-20">
        <div>
          <p
            className="mb-4 sm:mb-5 uppercase text-[#b0aaa3]"
          ...
          <div className="my-5 sm:my-6 w-10 bg-[#b0aaa3]/30" style={{ height: "0.5px" }} />

          <p
            className="italic text-[#b0aaa3]/70"
            style={{ fontFamily: '"Cormorant Garamond", serif', fontSize: "clamp(14px, 2.5vw, 18px)", fontWeight: 300, letterSpacing: "0.08em" }}
          >
      ...
      {/* Bottom Navigation */}
      <div className="absolute bottom-6 sm:bottom-10 left-1/2 -translate-x-1/2 z-20 flex items-center text-[#b0aaa3] text-[9px] sm:text-xs whitespace-nowrap">
        <button className="px-4 sm:px-8 hover:text-white transition-colors duration-500">DISCOVER</button>
        <span className="h-4 w-px bg-[#b0aaa3]/30" />
        <button className="px-4 sm:px-8 hover:text-white transition-colors duration-500">TIMELESS</button>
        <span className="h-4 w-px bg-[#b0aaa3]/30" />
        <button className="px-4 sm:px-8 hover:text-white transition-colors duration-500">BRILLIANCE</button>
      </div>
    </section>
  );
}
